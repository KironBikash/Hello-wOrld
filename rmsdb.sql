...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 28, 2017 at 02:28 PM
...
--
-- Table structure for table `ajax_exmple`
--

CREATE TABLE `ajax_exmple` (
...
--
-- Dumping data for table `ajax_exmple`
--

INSERT INTO `ajax_exmple` (`name`, `age`, `sex`, `wpm`) VALUES
('Frank', 45, 'm', 87),
('Jerry', 120, 'm', 20),
('Jill', 22, 'f', 72),
('Julie', 35, 'f', 90),
...
--
-- Indexes for table `ajax_exmple`
--
ALTER TABLE `ajax_exmple`
